...
export const formattedLink = (obj: youdaoResult) => {
  ...
  const linkQuery = obj.l === "zh-CHS2en" ? obj.query : ifCNQuery ? obj.translation : obj.query;
  const link = terminalLink(`web dict`, `https://www.youdao.com/w/${translateType}/${linkQuery}`);
